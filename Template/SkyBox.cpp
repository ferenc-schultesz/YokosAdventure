...
bool CSkybox::Create(const char *bmpDirectory, const float fSize)
{
	// Load textures
	CTexture texture;
	texture.Load("Resources\\Textures\\skybox\\sleepyhollow_bk.jpg", true);
	m_textureIDs[SKYBOX_BACK_ID] = texture.m_textureID;

	texture.Load("Resources\\Textures\\skybox\\sleepyhollow_ft.jpg", true);
	m_textureIDs[SKYBOX_FRONT_ID] = texture.m_textureID;

	texture.Load("Resources\\Textures\\skybox\\sleepyhollow_dn.jpg", true);
	m_textureIDs[SKYBOX_BOTTOM_ID] = texture.m_textureID;

	texture.Load("Resources\\Textures\\skybox\\sleepyhollow_up.jpg", true);
	m_textureIDs[SKYBOX_TOP_ID] = texture.m_textureID;

	texture.Load("Resources\\Textures\\skybox\\sleepyhollow_lf.jpg", true);
	m_textureIDs[SKYBOX_LEFT_ID] = texture.m_textureID;

	texture.Load("Resources\\Textures\\skybox\\sleepyhollow_rt.jpg", true);
