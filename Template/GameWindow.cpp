...
HDC GameWindow::Init(HINSTANCE hinstance)
{
	...
	CreateGameWindow("-- Yokho's adventure -- (by Ferenc Schultesz)");
...
void GameWindow::CreateGameWindow(LPSTR title)
{
	...
	m_hwnd = CreateWindow(m_sClass, m_sClass, style, 200, 100, SCREEN_WIDTH, SCREEN_HEIGHT, NULL, NULL, m_hinstance, NULL);
...
int GameWindow::UpdateFrameRate(double dt)
{
